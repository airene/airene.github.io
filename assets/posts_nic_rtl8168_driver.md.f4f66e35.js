...
<span class="line"></span></code></pre></div><p>实际效果</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">root@nas:~# iperf3 -c 10.0.0.30 -i 1 -t 10</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">iperf Done.</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>局域网表现还不是很明显，没换之前上下行700+/700+，换完 940/830，基本到顶了，这个速度经过了光猫和小米路由器<br> 外网差别挺大的，wget下载也好了，没换驱动之前经常才1M左右的速度 <strong>很奇怪</strong>，换完就能到网速上限了</p>`,6);function A(n,y,D,_,b,d){return e(),t("div",null,[s("h1",r,[l(p(n.$frontmatter.title)+" ",1),i]),C])}const B=a(o,[["render",A]]);export{M as __pageData,B as default};
