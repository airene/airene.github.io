import{_ as a,o as i,c as n,ah as l}from"./chunks/framework.CNtRuq8R.js";const F=JSON.parse('{"title":"记录一下 caddy 的 log 主要配置","description":"caddy 的 log 和 nginx 不太一样，nginx 属于“单行字符串”类型，caddy 的核心宗旨就是 json 和 metrics 丰富","frontmatter":{"date":"2024-10-10T00:00:00.000Z","title":"记录一下 caddy 的 log 主要配置","category":"caddy","tags":["caddy"],"description":"caddy 的 log 和 nginx 不太一样，nginx 属于“单行字符串”类型，caddy 的核心宗旨就是 json 和 metrics 丰富"},"headers":[],"relativePath":"posts/caddy_config.md","filePath":"posts/caddy_config.md"}'),p={name:"posts/caddy_config.md"};function e(t,s,h,k,d,r){return i(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="记录一下-caddy-的-log-主要配置" tabindex="-1">记录一下 caddy 的 log 主要配置 <a class="header-anchor" href="#记录一下-caddy-的-log-主要配置" aria-label="Permalink to &quot;记录一下 caddy 的 log 主要配置&quot;">​</a></h1><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
